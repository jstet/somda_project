...
# #     )
# # def test_extract_page_2009():
# #     resource_path = importlib_resources.files("tests.data.pageviews_parquet").joinpath("2009_05_21_04.parquet")
# #     path = str(resource_path)
# #     temp = extract_page(path, "cs", "Volby_do_Evropského_parlamentu_2009")
# #     print(temp)
...
# def test_extract_election_page_timeseries_2009():
#     resource_path = importlib_resources.files("tests.data.pageviews_parquet").joinpath("2009_05_25_14.parquet")
#     path = str(resource_path)  # Convert the Path object to a string
#     path = extract_election_page_timeseries(path, "2009_05_25_14", 2009, eu_elections)
#     assert isinstance(path, str)
#     os.remove(path)
